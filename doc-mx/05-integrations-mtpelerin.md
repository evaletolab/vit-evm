...
**Upgrade path** : s'inscrire au programme partenaire Mt Pelerin pour récupérer `code` + secret HMAC, re-câbler l'iframe avec `_ctkn` signé et domaine `3vit.ch` (ou équivalent) allowlisté.
